 ...
 * @author TCC S05 G10
 */
public class JFdificilfase2 extends javax.swing.JFrame {
     ...
     */
       ...
       JFvoceganhoufased2 obj2 = new JFvoceganhoufased2();
...
obj.setVisible(true);  
obj.respostacorreta(" "+ ent1 +" " + ent2 + " "+ ent3 +" " + ent4 + " ", " dificil 2 de 2");
dispose(); 
   }    
    ...
    private void initComponents() {
        ...
        JLfigura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/circuito nenounot.jpg"))); // NOI18N
...
if (((entrada1.equalsIgnoreCase("0"))||(entrada1.equalsIgnoreCase("1")))&& ((entrada2.equalsIgnoreCase("0"))||(entrada2.equalsIgnoreCase("1"))) && ((entrada3.equalsIgnoreCase("0"))||(entrada3.equalsIgnoreCase("1")))&& ((entrada4.equalsIgnoreCase("0"))||(entrada4.equalsIgnoreCase("1"))))  {
   if ((entrada1.equalsIgnoreCase(ent1))&&(entrada2.equalsIgnoreCase(ent2))&& (entrada3.equalsIgnoreCase(ent3))&&(entrada4.equalsIgnoreCase(ent4))){
     JFvoceganhoufased3 obj = new JFvoceganhoufased3();
...
dispose();
     ...
     JFfimdejogo obj = new JFfimdejogo();
obj.setVisible(true); 
obj.respostacorreta(" "+ ent1 +" " + ent2 + " "+ ent3 +" " + ent4 + " ", " dificil 1 de 2");
dispose();
   }
...
JOptionPane.showOptionDialog(null, "Coloque 1 ou 0", "Insira o valor correto", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, opcoes, opcoes[0]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFdificilfase2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFdificilfase2().setVisible(true);
