 ...
 * @author TCC S05 G10
 */
public class JFfacilfase4 extends javax.swing.JFrame {
     ...
     */
       ...
       JFvoceganhoufase3 obj2 = new JFvoceganhoufase3();
...
public void contar(){
       ...
       valorinicial = valorinicial - 100;
           ...
           if (valor3 < 10){
           JLtime.setText("00:0"+ valor3); 
           }else {
    JLtime.setText("00:"+ valor3); 
...
obj.setVisible(true);  
obj.respostacorreta(" "+ ent1 +" " + ent2 + " "+ ent3 +" " + ent4 + " ", "facil 4 de 5");
dispose(); 
   }    
    ...
    private void initComponents() {
        ...
        JLfigura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/circuitone.jpg"))); // NOI18N
...
if (((entrada1.equalsIgnoreCase("0"))||(entrada1.equalsIgnoreCase("1")))&& ((entrada2.equalsIgnoreCase("0"))||(entrada2.equalsIgnoreCase("1"))) && ((entrada3.equalsIgnoreCase("0"))||(entrada3.equalsIgnoreCase("1")))&& ((entrada4.equalsIgnoreCase("0"))||(entrada4.equalsIgnoreCase("1"))))  {
   if ((entrada1.equalsIgnoreCase(ent1))&&(entrada2.equalsIgnoreCase(ent2))&& (entrada3.equalsIgnoreCase(ent3))&&(entrada4.equalsIgnoreCase(ent4))){
     JFvoceganhoufase4 obj = new JFvoceganhoufase4();
...
JOptionPane.showOptionDialog(null, "Coloque 1 ou 0", "Insira o valor correto", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, opcoes, opcoes[0]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFfacilfase4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFfacilfase4().setVisible(true);
