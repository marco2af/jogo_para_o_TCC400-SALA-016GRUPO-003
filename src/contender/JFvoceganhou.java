 ...
 * @author TCC S05 G10
 */
public class JFvoceganhou extends javax.swing.JFrame {
 ...
 Contador retornapontuação = new Contador();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFvoceganhou.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFvoceganhou().setVisible(true);
            }
        });
    }
