 ...
 *@author TCC S05 G10
 */
public class JFvoceganhoufase3 extends javax.swing.JFrame {
private int valort;
    /**
     * Creates new form JFvoceganhou
     */
    public JFvoceganhoufase3() {
        initComponents();
          setLocationRelativeTo(null);
        this.setResizable(false);
        JFfacilfase3 obj = new JFfacilfase3();
...
int totaldafase;
  ...
  Contador pontuação = new Contador();
         JFfacilfase3 obj2 = new JFfacilfase3();
...
Contador retornapontuação = new Contador();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFvoceganhoufase3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFvoceganhoufase3().setVisible(true);
            }
        });
    }
