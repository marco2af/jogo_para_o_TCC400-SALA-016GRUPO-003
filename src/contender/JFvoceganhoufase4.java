 ...
 * @author TCC S05 G10
 */
public class JFvoceganhoufase4 extends javax.swing.JFrame {
private int valort;
    /**
     * Creates new form JFvoceganhou
     */
    public JFvoceganhoufase4() {
        initComponents();
          setLocationRelativeTo(null);
        this.setResizable(false);
        JFfacilfase4 obj = new JFfacilfase4();
...
int totaldafase;
  ...
  Contador pontuação = new Contador();
         JFfacilfase4 obj2 = new JFfacilfase4();
...
Contador retornapontuação = new Contador();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFvoceganhoufase4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFvoceganhoufase4().setVisible(true);
            }
        });
    }
