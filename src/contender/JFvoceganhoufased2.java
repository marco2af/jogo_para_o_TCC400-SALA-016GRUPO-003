 ...
 * @author TCC S05 G10
 */
public class JFvoceganhoufased2 extends javax.swing.JFrame {
private int valort;
    /**
     * Creates new form JFvoceganhou
     */
    public JFvoceganhoufased2() {
        initComponents();
...
int totaldafase;
  ...
  Contador pontuação = new Contador();
         JFdificilfase1  obj2 = new JFdificilfase1 ();
...
Contador retornapontuação = new Contador();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFvoceganhoufased2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFvoceganhoufased2().setVisible(true);
            }
        });
    }
